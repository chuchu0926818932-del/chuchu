...
$outputWorkbook = "C:\Users\USER\Desktop\短影音文案\源源不絕主題庫\SNL_每日新增短影音主題庫_2026-07-25.xlsx"
$dataPath = "C:\Users\USER\AppData\Local\Temp\daily-topics-2026-07-25.json"
$sheetName = "每日新增_2026-07-25"
...
foreach ($topic in $topics) {
  foreach ($field in $required) {
    if ([string]::IsNullOrWhiteSpace([string]$topic.$field)) { throw "$($topic.id) is missing $field." }
  }
}
...
try {
  ...
  $table.Name = "DailyTopics20260725"
